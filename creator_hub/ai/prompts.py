...
PROMPT_VERSIONS = {
    ...
    "query_planner": "query-planner-v6",
    "ask_hub": "ask-hub-plan-v2",
    "weekly_brief": "weekly-brief-v1",
}
...
def weekly_brief(context: dict[str, Any]) -> str:
    return BASE_RULES + "\nCreate a seven-day Creator Intelligence Brief. Summarize discoveries, monitoring risks, workflow changes and prioritized actions using only the supplied aggregates." + _payload("WEEK_CONTEXT", context)
