...
This document covers routine operation for YouTube Creator Data Hub . All commands are run from the Skill root. On Windows, `scripts\python-run.cmd` automatically resolves `python` or `py -3`.
...
## Manual Creator availability overrides ()
